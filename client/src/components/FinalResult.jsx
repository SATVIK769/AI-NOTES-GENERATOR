...
function FinalResult({result}) {
    ...
    if(!result || !result.subTopics || !result.questions || !result.questions.short || !result.questions.long || !result.questions.diagram || !result.revisionPoints || !result.notes){
        return null;
    }
  return (
    <div className='mt-6 p-3 space-y-10 bg-white'>
        ...
        {quickRevision && 
            ...
            <section>
                ...
                <ul className='list-disc ml-6 text-gray-700'>
                    {result.questions.diagram.map((q, i) => (
                        <li key={i}>{q}</li>
                    ))}

            ...
            <div className='grid grid-cols-1 md:grid-cols-3 gap-8 items-start'>
                ...
                <div className='text-center'>
                    ...
                    <ul className='space-y-2 text-sm'>
                        ...
                        <li onClick={() => ("/history")} className='text-gray-300 hover:text-white transition-colors'>History</li>
                        <li onClick={() => ("/pricing")} className='text-gray-300 hover:text-white transition-colors'>Add Credits</li>
                    </ul>
                </div>
                <div className='text-center'>

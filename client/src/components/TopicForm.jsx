...
function TopicForm({setResult, setLoading, loading, setError}) {
    ...
    const handleSubmit = async () => {
        ...
        try{
            ...
            console.log("Failed to fetch notes from server");
  ...
  return (
    <motion.div
        ...
        className='rounded-2xl bg-linear-to-br from-black/90 via-black/80 to-black/90 backdrop-blur-2xl border border-white/10
                ...
                <div className='mt-4 space-y-2'>
                    ...
                    '>
                        <motion.div
                            ...
                            transition={{name:"easeOut", duration:0.6}}
        ...
        <div
            ...
            >
                <motion.div
                    ...
                    className='absolute top-0.5 h-5 w-5 rounded-full bg-white shadow-[0_5px_5px_rgba(0,0,0,0.5)]'

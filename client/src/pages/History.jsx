    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-100 to-gray-200 px-6 py-8">
      ...
      >
        ...
        <div className="flex items-center gap-4 flex-wrap">
          {!isSidebarOpen && <button onClick={() => setSidebarOpen(true)} className=" text-white text-2xl"><GiHamburgerMenu/></button>}
          ...
          >
            ...
            <motion.span
              ...
              className="ml-2 h-5 w-5 flex items-center
                        justify-center rounded-full bg-white text-xs font-bold"
            >
              ➕
            </motion.span>
          </button>
        ...
        <AnimatePresence>
          {isSidebarOpen &&
            <motion.div
              ...
              className='fixed lg:relative top-0 left-0 z-50 lg:z-auto w-72 lg:w-auto h-full lg:h-[75vh] lg:rounded-3xl lg:col-span-1 bg-black/90 lg:bg-black/80 backdrop-blur-xl border border-white/10 shadow-[0_20px_45px_rgba(0,0,0,0.6)] p-5 overflow-y-auto'
            >
              <button onClick={() => setSidebarOpen(false)} className="lg:hidden text-white mb-4">
                ⬅️ back
              </button>
              ...
              <div className="mb-4 space-y-1">
                ...
                <ul className="space-y-3">
                  {topics.map((t) => (
                    <li key={t._id} onClick={() => openNotes(t._id)}className={`cursor-pointer rounded-xl p-3 border transition-all ${
                      ActiveNoteId === t._id
                        ? "bg-indigo-500/30 border-indigo-400 shadow-[0_0_0_1px_rgba(90,102,241,0.6)]"
                    ...
                    `}>
                      ...
                      <div className="flex flex-wrap gap-2 mt-2 text-xs">
                        ...
                        {t.examType && <span className="px-2 py-0.5 rounded-full bg-purple-500/20 text-purple-300">ExamType : {t.examType}</span>}
                      </div>
          ...
          <motion.div
            ...
            className={`${
                ...
                } rounded-xl bg-white shadow-xl p-6 min-h-[75vh]`}>

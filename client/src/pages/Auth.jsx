...
function Auth() {
    ...
    return(
        <div className="min-h-screen overflow-hidden bg-white text-black px-8">
            ...
            >
                <h1 className='text-5xl lg:text-6xl font-extrabold leading-tight bg-linear-to-br from-black/90 via-black/60 to-black/90
            ...
            <motion.div>
                <div className='grid grid-cols-1 sm:grid-cols-2 gap-8'>
                    <Feature icon="🎁" title="50 Free Credits" des="Start with 50 credits to generate notes without paying."></Feature>
                    <Feature icon="📘" title="Exam Notes" des="High-yield, revision-ready exam-oriented notes."></Feature>
                    <Feature icon="📂" title="Project Notes" des="Well-structured documentation for exam-oriented notes."></Feature>
                    <Feature icon="📊" title="Charts & Graphs" des="Auto-generated diagrams, charts and flow graphs."></Feature>
...
function Feature({icon, title, des}){
    return(
        <motion.div
            ...
            transition={{type:"spring", stiffness:200, damping:18}}
            className='relative rounded-2xl p-6 bg-linear-to-br from-black/90 via-black/80 to-black/90
